...
public class TabView extends LinearLayout {
    ...
    public TabView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mImageView.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        ...
        // Set width on tabs
        this.setLayoutParams(new LayoutParams(200, LayoutParams.MATCH_PARENT));
    }
